...
import { Menu, Settings, Bell, Sun, Moon } from "lucide-react"
...
const Navbar = () => {
  ...
  const isDsrkMode = useAppSelector((state)=> state.global.isDarkMode)
      
const toggleDarkMode = () => {
  dispatch(setIsDarkMode(!isDsrkMode));
}
        ...
        <div className="hidden md:flex justify-between items-center gap-5">
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            <div className="w-9 h-9">
              image
            </div><span className="font-semibold">My Name</span>
          </div>
        </div>
        <Link href="/settings">
