...
//APPLY DIFFERENT SETTINGS IF IT'S COLLAPSED OR NOT
  ...
  return (
    <div className= {sidebarClassNames}>
      ...
      <div className={`flex justify-between gap-3 md:justify-normal items-center pt-8 ${
        ...
        <button
          className="md:hidden px-3 py-3 bg-gray-100 rounded-full hover:bg-blue-500"
      ...
      <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
        <p className="text-center text-xs text-gray-500">&copy; 2025 Patostock</p>
      </div>
    </div>
  );
};
